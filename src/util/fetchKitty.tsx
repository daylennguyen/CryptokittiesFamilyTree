...
export function fullAddressToShortID(address: string) {
	let result: string = address.slice(
...
function makeEdgeComponent(json) {
	return <Edge key={json.id} id={json.id} from={json.from} to={json.to} />;
}
